...
Page({
  ...
  onLoad: function (e) {
    ...
    wx.request({
      url: 'https://yaopinzhinan.com/shop/goods/detail',
      data: {
        id: e.id
      },
      success: function(res) {
      ...
      complete: function(res) {
        that.setData({
          goodsDetail: {
            basicInfo: {
              ...
              name: '环球绘本',
              numberOrders: 1203,
              pic: 'https://yaopinzhinan.com/static/goods_1.jpg'
            },
            pics: [
              { pic: 'https://yaopinzhinan.com/static/goods_1.jpg'}              
            ],
        ...
        var article = '<div>我是HTML代码<img src="https://yaopinzhinan.com/static/goods_1.jpg"></img></div>';
